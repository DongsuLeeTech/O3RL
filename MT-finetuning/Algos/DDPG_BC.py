...
class Actor(nn.Module):
    ...
    def init_layer(self):
        ...
        nn.init.constant_(self.l3.bias.data)
...
class DDPGBC(object):
    ...
    def load(self, filename):
        ...
        self.actor_target.load_state_dict(torch.load(filename + 'actor_target'))
        self.critic.load_state_dict(torch.load(filename + 'critic'))
        self.critic_target.load_state_dict(torch.load(filename + 'critic_target'))
