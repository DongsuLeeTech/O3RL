...
parser.add_argument('--group', default='ABS-MT-IQL-ft-forgetting')
parser.add_argument('--name', default='MT-IQL-ft-forgetting')
...
def main(args, replay_buffer):
    ...
    for ep in range(1, args.epochs + 1):
        for env, road in zip([env_list[0]], ['MA_4BL']):
            if road == 'MA_4BL':
                warmup_ts = 900
            elif road == 'MA_5LC':
                warmup_ts = 125
...
if __name__=="__main__":
    ...
    for i in env_list:
        ...
        for j in seed_list:
            ...
            wandb.finish()
            args.name = 'MT-IQL-ft-forgetting'
