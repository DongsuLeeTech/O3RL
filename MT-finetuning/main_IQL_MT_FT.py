...
parser.add_argument('--q_lr', type=float, default=3e-04,)
...
parser.add_argument('--q_epochs', type=int, default=5)
parser.add_argument('--q_train', action='store_true')
parser.add_argument('--warm_start', action='store_true')
parser.add_argument('--sac_alpha', type=float, default=0.01)
parser.add_argument('--alpha_lr', type=float, default=1e-04)

parser.add_argument('--project', default='ABS')
parser.add_argument('--group', default='ABS-MT-IQL-fine-tuning')
parser.add_argument('--name', default='MT-IQL-finetune')
...
if args.Q_init:
    fullname = fullname + '-Q_init(onlyQ)'
    group = group + '-Q_init(onlyQ)'
...
if __name__=="__main__":
    seed_list = [1, 2, 3]
    env_list = ['medium-random', 'final-random', 'final-medium', 'humanlike', 'medium']
    args.road = 'mixed_env'
    for i in env_list:
        args.dataset = i
        for j in seed_list:
