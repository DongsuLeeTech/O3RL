...
parser.add_argument('--group', default='ABS-MT-AWAC-PROTO')
parser.add_argument('--name', default='MT-AWAC-PROTO')
...
def main(args, replay_buffer):
    ...
    policy = PROTO(args, num_inputs, num_actions, max_action)
